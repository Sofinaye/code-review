...
# 📖  Musical instrument shop web page<a name="about-project"></a>



**Musical instrument shop web page** is a static portfolio website.

## 🛠 Built With <a name="built-with"></a>

### Tech Stack <a name="tech-stack"></a>

The musical instrument shop web page is built with html, css and linter configration with git workflow. 
...
```sh
  cd my-folder
  git clone git@github.com:Sofinaye/code-review.
```
